...
def plot_according_to_point(vis_attr, im, source_points, map_h, map_w, loc_offset_scale, color=[255, 0, 0]):
...
if __name__ == '__main__':
    ...
    #加载某一个 Reppoints
    reppoints = mmcv.load(
        '/home/zxn/RepPoints/zxn_result/debug/repoint_baseline_do3/kittibddwayo_epoch20_thres02_nms05_baseline_rerun_02142013_sub13/baseline/reppoints_13_all.pkl')
    #这个path是用来干什么的？
    path = '/home/zxn/RepPoints/zxn_result/debug/repoint_baseline_do3/kittibddwayo_epoch20_thres02_nms05_baseline_rerun_02142013_sub13/baseline'
