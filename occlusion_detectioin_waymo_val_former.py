...
mmcv.dump(test_data_all,os.path.join(data_path,'occlusion_waymo_val_zxn.json'))
# mmcv.dump(train_data_all,os.path.join(data_path,'occlusion_train_zxn.json'))
mmcv.dump(test_data_v,os.path.join(data_path,'occlusion_waymo_val_v_zxn.json'))
mmcv.dump(test_data_p,os.path.join(data_path,'occlusion_waymo_val_p_zxn.json'))
mmcv.dump(test_data_vp,os.path.join(data_path,'occlusion_waymo_val_vp_zxn.json'))

print('frame count')
print('val_data_all:','%7d'%len(test_data_all))
for i in range(10):
