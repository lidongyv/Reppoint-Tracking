...
def main():
	...
	optimizer = obj_from_dict(cfg.optimizer, torch.optim,
							 dict(params=list(model_load.bbox_head.conv11_offset.parameters())+ \
										 ...
										 list(model_load.bbox_head.weight_feature1.parameters())+ \
										 list(model_load.bbox_head.weight_feature2.parameters())+ \
										 list(model_load.bbox_head.weight_feature3.parameters())+ \
										 list(model_load.bbox_head.weight_feature4.parameters())+ \
										 list(model_load.bbox_head.weight_feature5.parameters())
									 ))
	check_video=None
	try:
