...
checkpoint_file='/home/ld/RepPoints/debug/stsn_one_support/epoch_13.pth'
...
out_path='/home/ld/RepPoints/debug/stsn_one_support/epoch13_thres0.1_nms0.5_with2'
if not os.path.exists(out_path):
	os.mkdir(out_path)
	for i in range(support_count+2):
...
mmcv.dump(bbox_result, os.path.join(out_path,'det_result.pkl'))
mmcv.dump(loc_result, os.path.join(out_path,'loc_result.pkl'))
