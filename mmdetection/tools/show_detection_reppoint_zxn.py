...
out_name='baseline'
out_path='/home/zxn/RepPoints/zxn_result/debug/repoint_baseline_do3/kittibddwayo_epoch20_thres03_nms05_baseline_rerun_02142013_sub13/'+out_name
...
loc_result=mmcv.load('/home/zxn/RepPoints/zxn_result/debug/repoint_baseline_do3/kittibddwayo_epoch20_thres03_nms05_baseline_rerun_02142013_sub13/baseline/loc_result_13_all.pkl')
# temp_loc_result = []
# # precess
...
for i in range(num_classes):
	...
	for j in range(len(cls_gts)):
		...
		if len(not_detected)>0:
			...
			mmcv.dump([no_loc,j,file_name], os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'not_detected',img_name.split('/')[-1].split('.')[0]+'.pkl'))
		...
		if len(wrong_detected)>0:
			...
			file_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'wrong_detected',img_name.split('/')[-1])
			mmcv.dump([wrong_loc,j,file_name], os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'wrong_detected',img_name.split('/')[-1].split('.')[0]+'.pkl'))
