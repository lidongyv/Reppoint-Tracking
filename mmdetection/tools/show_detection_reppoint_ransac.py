...
config_file = '/home/ld/RepPoints/ld_result/stsn_one_ransac_do3/reppoint/code/stsn_do3.py'
...
out_path='/home/ld/RepPoints/ld_result/stsn_one_ransac_do3/reppoint/epoch_23_thres0.3_nms0.5_support_5re/'+out_name
results=[]
video_length=0
...
offset_data=[]
refer_record=mmcv.load('/home/ld/RepPoints/ld_result/stsn_one_ransac_do3/reppoint/epoch_23_thres0.3_nms0.5_support_5ori/agg/det_result.pkl')
...
for i in range(num_classes):
	...
	for j in range(len(cls_gts)):
		...
		if len(addition)>0:
			...
			mmcv.dump([addition_loc,j,file_name], os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'addition',img_name.split('/')[-1].split('.')[0]+'.pkl'))
