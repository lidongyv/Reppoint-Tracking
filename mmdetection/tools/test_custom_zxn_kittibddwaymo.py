...
config_file = '/home/zxn/RepPoints/zxn_result/bdd/code/reppoints_moment_r101_dcn_fpn_kitti_agg_fuse_st_baseline.py'
...
# with open('/backdata01/KITTI/kitti/tracking/occlusion_test_v.json', 'r') as f:
#     datas = json.load(f)
...
support_count = 2
out_name = 'refer'
out_path = '/home/zxn/RepPoints/zxn_result/debug/reppoints_moment_r101_dcn_fpn_bdd_agg_fuse_st_futhernms/debug_kittibddwaymo'
