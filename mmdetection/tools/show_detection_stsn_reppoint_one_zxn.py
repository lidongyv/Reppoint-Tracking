...
config_file = '/home/zxn/RepPoints/zxn_result/kittibddwaymo/stsn_one_do3/code/stsn_do3.py'
...
out_name='baseline'
# out_path='/home/ld/RepPoints/ld_result/stsn_class_support/epoch_9_thres0.1_nms0.5_with2/'+out_name
out_path='/home/zxn/RepPoints/zxn_result/debug/stsn_one_do3/kittibddwayo_epoch30_thres03_nms05_baseline/'+out_name
results=[]
video_length=0
...
offset_data=[]
refer_record=mmcv.load('/home/zxn/RepPoints/zxn_result/debug/repoint_baseline_do3/kittibddwayo_epoch20_thres03_nms05_baseline_rerun_02142013_sub13/baseline/det_result_13_all.pkl')
result_record=mmcv.load(os.path.join(out_path,'det_result_13_all.pkl'))
loc_result=mmcv.load(os.path.join(out_path,'loc_result_13_all.pkl'))
img_record=mmcv.load(os.path.join(out_path,'images_13_all.pkl'))
...
for i in range(num_classes):
	...
	for j in range(len(cls_gts)):
		...
		if len(addition)>0:
			...
			if 'kitti' in img.split('/'):
				dataset_video_name = 'kitti_' + img.split('/')[-2]
			if 'bdd' in img.split('/'):
				dataset_video_name = 'bdd_' + img.split('/')[-2]
			if 'waymo' in img.split('/'):
				dataset_video_name = 'waymo_' + img.split('/')[-2]

			file_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'addition',img_name.split('/')[-1])
			...
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'addition')):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'addition'))
			imshow_det_bboxes(
					img,
					addition,
			...
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support1')):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support1'))
			img=img_record[j][1]
			add_support1_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support1',img.split('/')[-1])
			imshow_det_bboxes(
					img,
					addition,
					np.ones(addition.shape[0]).astype(np.int)*i,
			...
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support2')):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support2'))
			img=img_record[j][2]
			add_support2_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'add_support2',img.split('/')[-1])
			imshow_det_bboxes(
					img,
					addition,
					np.ones(addition.shape[0]).astype(np.int)*i,
			...
			mmcv.dump([addition_loc,j,file_name,add_support1_name,add_support2_name], os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'addition',img_name.split('/')[-1].split('.')[0]+'.pkl'))
		...
		if len(not_detected)>0:
			...
			file_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'not_detected',img_name.split('/')[-1])
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name)):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name))
			...
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support1')):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support1'))
			img=img_record[j][1]
			support1_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support1',img.split('/')[-1])
			imshow_det_bboxes(
					img,
					not_detected,
					np.ones(not_detected.shape[0]).astype(np.int)*i,
			...
			if not os.path.exists(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support2')):
				os.mkdir(os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support2'))
			img=img_record[j][2]
			support2_name=os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'support2',img.split('/')[-1])
			imshow_det_bboxes(
					img,
					not_detected,
					np.ones(not_detected.shape[0]).astype(np.int)*i,
			...
			mmcv.dump([no_loc,j,file_name,support1_name,support2_name], os.path.join(os.path.join(out_path),classes[i],dataset_video_name,'not_detected',img_name.split('/')[-1].split('.')[0]+'.pkl'))
