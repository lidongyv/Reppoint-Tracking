...
from mmdet.core import (PointGenerator, multi_apply, multiclass_nms, multiclass_nms_allclasses,
                        point_target)
...
class RepPointsHead_allclasses(nn.Module):
    """RepPoint head.
    ...
    def __init__(self,
                 ...
                 moment_mul=0.01):
        super(RepPointsHead_allclasses, self).__init__()
    ...
    def forward_single(self, x):
        ...
        self.offset.append(dcn_offset.data.cpu().numpy())
        # print("dcn_offset:",dcn_offset.shape)
        # print(cls_out.shape)
        # if dcn_offset.shape[-1]==156:
        #     self.init_offset=dcn_offset
        #     self.refine_offset=pts_out_refine- dcn_base_offset
        # np.save('/home/hrb/offset/'+str(dcn_offset.shape[-1])+'.npy',dcn_offset.data.cpu().numpy())
    ...
    def get_bboxes_single(self,
        ...
        if nms:
            det_bboxes, det_labels = multiclass_nms_allclasses(mlvl_bboxes, mlvl_scores,
...
#         if nms:
#             det_bboxes, det_labels = multiclass_nms_allclasses(mlvl_bboxes, mlvl_scores,
#                                                     cfg.score_thr, cfg.nms, cfg.nms_further,
#                                                     cfg.max_per_img)
#             if not index:
#                 return det_bboxes, det_labels
#             else:
