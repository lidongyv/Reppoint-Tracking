...
class RepPointsHead_Reppoints_Baseline(nn.Module):
    """RepPoint head.
    ...
    def __init__(self,
                 ...
                 moment_mul=0.01):
        super(RepPointsHead_Reppoints_Baseline, self).__init__()
    ...
    def forward_single(self, x):
        ...
        self.cls_feat.append(cls_feat.data.cpu().numpy())
        self.cls_out.append(cls_out.data.cpu().numpy())
