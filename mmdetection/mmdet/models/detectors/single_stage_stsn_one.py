...
class SingleStageDetector_STSN_ONE(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 index=False):
        super(SingleStageDetector_STSN_ONE, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetector_STSN_ONE, self).init_weights(pretrained)
