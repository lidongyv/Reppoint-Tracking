...
class SingleStageDetector_Reppoints_Baseline(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 index=False):
        super(SingleStageDetector_Reppoints_Baseline, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetector_Reppoints_Baseline, self).init_weights(pretrained)
