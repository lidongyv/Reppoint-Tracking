...
class RepPointsDetector_Reppoints_Baseline(SingleStageDetector_Reppoints_Baseline):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(RepPointsDetector_Reppoints_Baseline,
              self).__init__(backbone, neck,agg, bbox_head, train_cfg, test_cfg,
                             pretrained)
