...
checkpoint_file='/home/ld/RepPoints/ld_result/reppoint_do3/epoch_23.pth'
...
support_num=5
out_name='agg'
out_path='/home/ld/RepPoints/ld_result/stsn_one_ransac_do3/reppoint_interative/epoch_23_thres0.3_nms0.5_support_'+str(support_num)+'re'
...
# result_record=mmcv.load('/home/ld/RepPoints/ld_result/stsn_one_ransac_do3/reppoint/epoch_23_thres0.3_nms0.5_support_5reactivate/agg/det_result.pkl')
...
for i,(frame) in enumerate(data):
	...
	for m in range(len(mask_t)):
		mask_data[m].append(mask_t[m])
...
mmcv.dump(mask_data, os.path.join(out_path,out_name,'mask.pkl'))

print('evaluating result of ', out_path+out_name)
kitti_eval(result_record, dataset)
